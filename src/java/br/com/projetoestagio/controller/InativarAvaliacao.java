 ...
 * @author MGP
 */
@WebServlet(name = "InativarAvaliacao", urlPatterns = {"/InativarAvaliacao"})
public class InativarAvaliacao extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            dao.inativar(avaliacao);
            request.getRequestDispatcher("ListarAvaliacao").forward(request, response);
        }
        catch(Exception ex){
            System.out.println("Erro ao inativar avaliacao" +ex.getMessage());
            ex.printStackTrace();
        }
    }
