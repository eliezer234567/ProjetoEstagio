 ...
 * @author Bruna Nobre
 */
@WebServlet(name = "CadastrarFrequenciaAlimentar", urlPatterns = {"/CadastrarFrequenciaAlimentar"})
public class CadastrarFrequenciaAlimentar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       try {
            ...
            if (dao.cadastrar(frequenciaalimentar)) {
                mensagem = "Cadastro realizado com sucesso!";
                String script="<script>$('#mensagemModal').modal('show');</script>";
                request.setAttribute("script", script);
            } else {
                mensagem = "Problemas ao realizar o cadastro!";
                String script="<script>$('#mensagemModal').modal('show');</script>";
                request.setAttribute("script", script);
            }
            request.setAttribute("sucesso", mensagem);
            request.getRequestDispatcher("nutricionista/cadastrarfrequenciaalimentar.jsp").forward(request, response);
        } catch (Exception ex) {
            System.out.println("Problemas no servlet ao cadastrar Frequencia Alimentar!Erro:" + ex.getMessage());
            ex.printStackTrace();
        }
