...
public class ListarPaciente extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            request.setAttribute("lista",dao.listarPacienteIndividuais(idPessoa));
            request.getRequestDispatcher("nutricionista/listarpaciente.jsp").forward(request, response);
        }catch(Exception ex){
