 ...
 */
@WebServlet(name = "AtivarMedicamentoSuplemento", urlPatterns = {"/AtivarMedicamentoSuplemento"})
public class AtivarMedicamentoSuplemento extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (dao.inativar(medicamentosuplemento)) {
                mensagem = "Medicamento/Suplemento ativado com sucesso!";
            } else {
                mensagem = "Problemas ao ativar Medicamento/Suplemento!";
            }
            request.setAttribute("mensagem", mensagem);
            request.getRequestDispatcher("ListarMedicamentoSuplemento").forward(request, response);
        } catch (Exception ex) {
            System.out.println("Problemas no Servlet ao ativar Medicamento/Suplemento! Erro: " + ex.getMessage());
            ex.printStackTrace();
        }
