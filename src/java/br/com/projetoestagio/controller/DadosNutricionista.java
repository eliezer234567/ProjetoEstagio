 ...
 * @author eliez
 */
@WebServlet(name = "DadosNutricionista", urlPatterns = {"/DadosNutricionista"})
public class DadosNutricionista extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            request.setAttribute("idNutricionista", dao.listar());
            request.getRequestDispatcher("cadastrarconsulta.jsp").forward(request, response);
            
        }catch(Exception ex){
            System.out.println("Erro ao listar nutricionista" +ex.getMessage());
            ex.printStackTrace();
        }
