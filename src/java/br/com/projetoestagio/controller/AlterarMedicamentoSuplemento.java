 ...
 */
@WebServlet(name = "AlterarMedicamentoSuplemento", urlPatterns = {"/AlterarMedicamentoSuplemento"})
public class AlterarMedicamentoSuplemento extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Boolean statusMedicamentoSuplemento = request.getParameter("statusmedicamentosuplemento") != null;
        //Integer sincronizaMedicamentoSuplemento = Integer.parseInt(request.getParameter("sincronizamedicamentosuplemento"));
        ...
        medicamentosuplemento.setNomeMedicamentoSuplemento(nomeMedicamentoSuplemento);
        medicamentosuplemento.setTipoMedicamentoSuplemento(tipoMedicamentoSuplemento);

        if(statusMedicamentoSuplemento == true){
        ...
        try {
            ...
            if (dao.alterar(medicamentosuplemento)) {
            ...
            request.getRequestDispatcher("CarregarMedicamentoSuplemento").forward(request, response);
        } catch (Exception ex) {
            System.out.println("Erro ao alterar Medicamento/Suplemento na Servlet" + ex.getMessage());
            ex.printStackTrace();
        }
