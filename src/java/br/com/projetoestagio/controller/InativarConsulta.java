 ...
 * @author Eliezer
 */
@WebServlet(name = "InativarConsulta", urlPatterns = {"/InativarConsulta"})
public class InativarConsulta extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String statusConsulta = request.getParameter("status");
        ...
        try{
            ...
            dao.inativar(consulta);
            request.getRequestDispatcher("ListarPaciente").forward(request, response);
        }
        catch(Exception ex){
            System.out.println("Erro ao inativar consulta" +ex.getMessage());
            ex.printStackTrace();
        }
    }
