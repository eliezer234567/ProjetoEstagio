 ...
 * @author Leticia
 */
public class ListarCardapioPaciente extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("paciente\\listarcardapio.jsp").forward(request, response);

        } catch (Exception ex) {
            System.out.println("ListarCardapioPaciente, Erro ao listar Cardápio: " + ex.getMessage());
            ex.printStackTrace();
        }
