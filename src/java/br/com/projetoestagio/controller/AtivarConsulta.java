 ...
 * @author Eliezer
 */
@WebServlet(name = "AtivarConsulta", urlPatterns = {"/AtivarConsulta"})
public class AtivarConsulta extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        consulta.setStatusConsulta("A");
        try {
            ConsultaDAOImpl dao = new ConsultaDAOImpl();
            if (dao.inativar(consulta)) {
                mensagem = "Consulta inativado com sucesso!";
            } else {
                mensagem = "Problemas ao inativar Consulta!";
            }
