 ...
 * @author Eliezer
 */
@WebServlet(name = "CarregarConsulta", urlPatterns = {"/CarregarConsulta"})
public class CarregarConsulta extends HttpServlet {
...
//        int idNutricionista = Integer.parseInt(request.getParameter("idNutricionista"));
        ...
        try {
            ...
            //carrega dados referente a consulta cadastrada e faz o redirecionamento para o servlet ListarConsulta
            //lista as consultas agendadas através do idPessoa
            ...
            System.out.println("Problemas ao carregar dados para a consulta! Erro: " + ex.getMessage());
            ex.printStackTrace();
        }
