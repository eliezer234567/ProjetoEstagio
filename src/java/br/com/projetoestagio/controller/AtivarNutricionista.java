 ...
 * @author Eliezer.L
 */
@WebServlet(name = "AtivarNutricionista", urlPatterns = {"/AtivarNutricionista"})
public class AtivarNutricionista extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (dao.inativar(nutricionista)) {
                mensagem = "Nutricionista ativado com sucesso!";
            } else {
                mensagem = "Problemas ao ativar Nutricionista!";
            }
