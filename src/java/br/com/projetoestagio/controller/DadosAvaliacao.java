 ...
 * @author Grazy
 */
@WebServlet(name = "DadosAvaliacao", urlPatterns = {"/DadosAvaliacao"})
public class DadosAvaliacao extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            request.getRequestDispatcher("/nutricionista/cadastraravaliacao_continuacao.jsp").forward(request, response);
        }catch (Exception ex){
            System.out.println("Problemas ao carregar dados da Avaliação! Erro: " + ex.getMessage());
        }
