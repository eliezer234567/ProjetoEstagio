                    ...
                    <div class="">
                        ...
                        <div class="row">
                                    ...
                                    <div style="widows: auto; overflow-x: scroll; overflow-y: hidden; white-space: nowrap" class="x_content">
                                                    ...
                                                    <td><a href="#"></a>
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <li><a href="CarregarConsultaRealizada?idConsulta=<%= consulta.getIdConsulta()%>">Reagendar</a>
                                                                </li>
                                        ...
                                        <!--Inicio modal erro alterar consulta -->
                                                ...
                                                <h4>${erroAlterarConsulta}</h4>
                                                        ...
                                                        <!--Inicio modal Reagendar Consulta -->
                                                        <div class="modal  bs-example-modalParaDiferenciarDeOutroModal-sm" id="erroConsulta" tabindex="-1" role="dialog" aria-hidden="true">
                                                            <div class="modal-dialog modal-sm">
                                                                <div class="modal-content">
                            ...
                            <br />
                                            ...
                                            <!--Inicio modal CarregarConsulta -->
                                            <div class="modal bs-example-modal-lg" tabindex="-1" id="ModalCarregarConsulta" role="dialog" aria-hidden="true">
                                                <div class="modal-dialog modal-lg">
                                                    <div class="modal-content">

                                                        <form id="alteraconsuolta"  name="alteraconsulta" action="CadastrarConsulta" method="POST" data-parsley-validate class="form-horizontal form-label-left">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Id Paciente <span class="required">*</span>
                                                                    </label>
                                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                                        <input type="text" id="idPaciente" value="${consulta.getPaciente().idPaciente}" name="idPaciente" placeholder="ID do Paciente" required="required" class="form-control col-md-7 col-xs-12">
                                                                    </div>
                                                                </div>
                                                                    <div class="form-group" hidden="">
                                                                    ...
                                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                                        <input type="text" id="idNutricionista" value="${consulta.getNutricionista().idNutricionista}" name="idNutricionista" placeholder="ID do Nutricionista" required="required" class="form-control col-md-7 col-xs-12">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                                        <input type="date" id="dataConsulta" name="dataConsulta" placeholder="Insira uma nova data" required="required" class="form-control col-md-7 col-xs-12">
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
