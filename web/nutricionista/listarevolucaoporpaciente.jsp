<%-- 
    Document   : listarevolucaoporpaciente
    Created on : 19/05/2016, 18:51:18
    Author     : Leticia
--%>
                                        ...
                                        <table id="example" class="table table-striped responsive-utilities jambo_table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="even pointer">
                                                    ...
                                                    <td id="idevolucao" ><%= evolucaopaciente.getIdEvolucaoPaciente()%></td> 
                                                    ...
                                                    <td><a href="#"></a>
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <li><a href="CarregarEvolucaoPaciente?idevolucaopaciente=<%= evolucaopaciente.getIdEvolucaoPaciente()%>&idpessoapaciente=<%=session.getAttribute("idpessoapa")%>">Alterar</a>
                                                                </li>
                                                                <li><a href="ExcluirEvolucaoPaciente?idevolucaopaciente=<%= evolucaopaciente.getIdEvolucaoPaciente()%>&idpessoapaciente=<%=session.getAttribute("idpessoapa")%>">Excluir</a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </td>
