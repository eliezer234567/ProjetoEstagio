<%-- 
    Document   : listaralimento
    Created on : 22/01/2016, 10:54:35
    Author     : Leticia
--%>
                                ...
                                <div class="x_panel">
                                    <div class="x_title">
                                        ...
                                        <div style="float: right">
                                            <form id="listarporstatus" name="listarporstatus" action="ListarAlimentoPorStatus" method="POST">
                                                <%
                                                    String statusAtivo = request.getParameter("statusalimentoativo");
                                                    String statusInativo = request.getParameter("statusalimentoinativo");
                                                    String status = "A";
                                                    if (statusAtivo != null) {
                                                        status = "A";
                                                    }
                                                    ...
                                                    if (statusAtivo != null && statusInativo != null) {
                                                        status = "AI";
                                                    }
                                                %>

                                                <input type="checkbox" name="statusalimentoativo" value="A" <% if (status.equals("A") || (status.equals("AI"))) {
                                                        out.print("checked");
                                                    }%>><label>Ativo</label>
                                                <input type="checkbox" name="statusalimentoinativo" value="I" <% if (status.equals("I") || (status.equals("AI"))) {
                                                        out.print("checked");
                                                    }%>><label>Inativo</label>
                                        ...
                                        <table id="example" class="table table-striped responsive-utilities jambo_table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="even pointer">
                                                    ...
                                                    <%--<td><%= alimento.getIdAlimento()%></td> --%>
                                                    <td><%= alimento.getNomeTabelaNutricionalAlimento()%></td>
                                                    <td><%= alimento.getNomeAlimento()%></td>
                                                    <td><%= alimento.getTipoAlimento()%></td>
                                                    <td><%= alimento.getEspecieAlimento()%></td>
                                                    <td><%= alimento.getProteinaAlimento()%></td>
                                                    <td><%= alimento.getLipideoAlimento()%></td>
                                                    <td><%= alimento.getCarboidratoAlimento()%></td>
                                                    <td><%= alimento.getFibraAlimentarAlimento()%></td>
                                                    <td><img width="150" height="100" src="DisplayImagemProduto?idproduto=<%=alimento.getIdAlimento() %>"/></td>

                                                    <%--<td><img src=""></td> --%>
                                                    <%--<td><%= alimento.getStatusAlimento()%></td> --%>
                                                    <%
                                                        String statusNovo = "";
                                                        String statusBotao = "";
                                                        if (alimento.getStatusAlimento().equals("A")) {
                                                            statusNovo = "I";
                                                            statusBotao = "Inativar";
                                                        } else if (alimento.getStatusAlimento().equals("I")) {
                                                            statusNovo = "A";
                                                            statusBotao = "Ativar";
                                                        } else {
                                                            statusBotao = "";
                                                    ...
                                                    <td><a href="#"></a>
                                                        <div class="buttons">
                                                            <button type="button" class="btn btn-default btn-sm"><a href="InativarAlimento?idalimento=<%=alimento.getIdAlimento()%>&status=<%=statusNovo%>"><%=statusBotao%></a></button>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td><a href="#"></a>
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <li><a href="CarregarAlimento?idalimento=<%=alimento.getIdAlimento()%>">Alterar</a>
                                                                </li>
