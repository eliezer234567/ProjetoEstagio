<%-- 
    Document   : listarcardapioporpaciente
    Created on : 19/05/2016, 16:34:16
    Author     : Leticia
--%>
                                ...
                                <div class="panel-heading" style="background-color:#eaf5f2"  >
                                    ...
                                    <h4 class="panel-title" >
                                        ...
                                        <a data-toggle="collapse" data-parent="#accordion" href="#collapse<%=i%>"> 
                                            ...
                                            <span style=""><b >Cardapio:</b> <%=cardapio1.getNomeCardapio()%>&nbsp</span>
                                            <span style=""><b >Data Inicio:</b> <%=conv.converterDataBr(cardapio1.getDataInicioCardapio())%>&nbsp</span>
