                                        ...
                                        <table id="example" class="table table-striped responsive-utilities jambo_table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="even pointer">
                                                    ...
                                                    <td><a href="mailto:"</a><%=paciente.getEmailPessoa()%></td>
                                                    <td><%=paciente.getTelefonePessoa()%></td>
                                                    <td><%=paciente.getIdadePaciente()%></td>
                                                    <td><%=paciente.getSexoPaciente()%></td>

                                                    <td><a href="#"></a>
                                                        <div class="buttons">
                                                            <a href="InativarPaciente?idPessoa=<%=paciente.getIdPessoa()%>"><button type="button" class="btn btn-default btn-sm">Inativar</button></a>
                                                        </div>
                                                    </td>
                                                    <td><a href="#"></a>
                                                        <div class="btn-group">
                                                            <button data-toggle="dropdown" class="btn btn-default dropdown-toggle btn-sm" type="button">Opções <span class="caret"></span> </button>
                                                            <ul class="dropdown-menu">
                                                                <li><a href="CarregarPaciente?idPessoa=<%=paciente.getIdPessoa()%>">Alterar</a>
                                                                </li>
                                                                <li><a href="ListarEvolucaoPorPaciente?idpessoapaciente=<%=paciente.getIdPessoa()%>">Evolução</a>
                                                                </li>
                                                                <li><a href="ListarCardapioPorPaciente?idpessoa=<%=paciente.getIdPessoa()%>">Cardápios</a>
                                                                </li>
                                                                
                                                            </ul>
                                                        </div>
                                                    </td>
                                            <!--<a href="CarregarPaciente?idPessoa=<%=paciente.getIdPessoa()%>"><button type="button" class="btn btn-primary" data-toggle="modal" data-target=".bs-example-modal-lg">Large modal</button></a>-->
