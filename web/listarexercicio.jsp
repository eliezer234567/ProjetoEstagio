        ...
        <table border="1" align="center">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><%=exercicio.getSincronizaExercicio() %></td>
                    ...
                    <td><a href="AtivarExercicio?idexercicio=<%=exercicio.getIdExercicio()%>"><input type="button" value="Ativar"</a></td>
                    <td><a href="InativarExercicio?idexercicio=<%=exercicio.getIdExercicio()%>"><input type="button" value="Inativar"</a></td>
                </tr>
